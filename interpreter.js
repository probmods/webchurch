...
//    console.log("trace_and_backtrace, initial: ",escodegen.generate(ast),"\n")
...
//    console.log("trace_and_backtrace, trace: ",global_trace.join("\n"),"\n  ret:",ret,"\n")
    var new_ast = esprima.parse(global_trace.join("\n"))
//    console.log("trace_and_backtrace, made new_ast\n")
    var cond = backTrace(new_ast)
//    console.log("trace_and_backtrace, conditions: ", cond, "\n")
    var new_trace = addConditions(global_trace.join("\n"),cond)
    new_trace = new_trace + ret
    
//    console.log("trace_and_backtrace, new_trace: ",new_trace,"\n")
...
//            //eagerly trace into the body of thunks:
//            if(ast.params.length == 0) {
//                var trace = trace_and_backtrace(ast.body,env)
//                ast = esprima.parse("(function(){"+trace+"})()").body[0].expression.callee
//                ast.env = env
//            }
            //represent a closure as the FunctionExpression AST with a pointer to the enclosing env.
            ast.env = env
            return ast
